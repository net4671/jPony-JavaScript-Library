/*!
 * jPony JavaScript Library v1.0
 * Date: 2017/06/04 7:30
 * Github: https://github.com/net4671/jPony-JavaScript-Library
 */
...
(function() {
	...
	n.fn = n.prototype = {
		...
		index: function(D) {
			return n.inArray(D && D.jPony ? D[0] : D, this)
		},
		attr: function(E, G, F) {
			var D = E;
			if(typeof E === "string") {
